...
$app->group('/api/v1/stocks/dn', function () {
    ...
    */
    $this->get('/', function (Request $request, Response $response, array $args) {
        ...
        WHERE th.prefix in (".$_prefix.") AND date(th.create_date) BETWEEN '".$_param['i-start-date']."'
...
/**
 * Stocks -> Purchase Order
 */
$app->group('/api/v1/stocks/po', function () {   
});
